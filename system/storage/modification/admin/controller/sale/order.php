...
class ControllerSaleOrder extends Controller {
	...
	public function getForm() {
		...
		if (!empty($order_info)) {
          ...
          $data['firstname'] = $this->request->get['customer_name'];
          $data['payment_firstname'] = $this->request->get['customer_name'];
          $data['shipping_firstname'] = $this->request->get['customer_name'];
      }

      if(isset($this->request->get['lastname'])) {
          $data['lastname'] = $this->request->get['lastname'];
          $data['payment_lastname'] = $this->request->get['lastname'];
          $data['shipping_lastname'] = $this->request->get['lastname'];
      }
      ...
      if(isset($this->request->get['customer_phone'])) {
          $data['telephone'] = $this->request->get['customer_phone'];
      }

      if(isset($this->request->get['address'])) {
          $data['payment_address_1'] = $this->request->get['address'];
          $data['shipping_address_1'] = $this->request->get['address'];
      } 

      if(isset($this->request->get['city'])) {
          $data['payment_city'] = $this->request->get['city'];
          $data['shipping_city'] = $this->request->get['city'];
      } 
      ...
      if(isset($this->request->get['zone_id'])) {
          $data['payment_zone_id'] = $this->request->get['zone_id'];
          $data['shipping_zone_id'] = $this->request->get['zone_id'];
      } 

			// end bitrix integration //
		}
	...
	public function info() {
		...
		if ($order_info) {
            ...
            $order_info_shiping = $this->model_sale_order->getOrderShipping($order_id);

            if($order_info_shiping){
                $data['shipping_order_name'] = $order_info_shiping['shipping_order_name'];
                $data['shipping_order_cost'] = $order_info_shiping['shipping_order_cost'];
            }
...
$data['text_first_referrer'] = $this->language->get('text_first_referrer');
$data['text_last_referrer'] = $this->language->get('text_last_referrer');
            ...
            if( isset($order_info['utm_source'])) {
...
if( isset($order_info['first_referrer'])) {
    $data['first_referrer'] =  $this->model_module_referrer->decode( $order_info['first_referrer'] );
} else {
    $data['first_referrer'] = "";
}
if( isset($order_info['last_referrer'])) {
    $data['last_referrer'] =  $this->model_module_referrer->decode( $order_info['last_referrer'] );
} else {
    $data['last_referrer'] = "";
}
