...
class ControllerDesignLayout extends Controller {
	...
	protected function getForm() {
		...
		$data['text_footercolumn'] = $this->language->get('text_footercolumn');
		$data['text_productblock'] = $this->language->get('text_productblock');
		$data['text_categorydata'] = $this->language->get('text_categorydata');
		$data['text_parallax'] = $this->language->get('text_parallax');
		$data['text_newstext'] = $this->language->get('text_newstext');
		$data['text_newscms'] = $this->language->get('text_newscms');
        ...
        $data['text_type_mobile'] = $this->language->get('text_type_mobile');

		if (isset($this->request->post['layout_type'])) {
			$data['layout_type'] = $this->request->post['layout_type'];
		} elseif (isset($this->request->get['layout_id'])) {
			$data['layout_type'] = $this->model_design_layout->getLayoutType($this->request->get['layout_id']);
		} else {
			$data['layout_type'] = 0;
		}
		// >
		...
		foreach ($extensions as $code) {
			...
			if ($code == 'catalog_quick_edit') continue;
