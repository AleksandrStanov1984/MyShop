        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                ...
                <div class="well" id="update-categories" style="display: none;">
                    <form action="<?php echo $action_import; ?>" method="post" enctype="multipart/form-data" id="import" class="form-horizontal">
                        <div class="form-group" style="padding: 0px;">
                            <div class="col-sm-6">
                                <label class="control-label" ><?php echo $entry_name_parent; ?></label>
                            ...
                            <div class="col-sm-4">
                                <label class="control-label" ><?php echo $entry_import_categories; ?></label>
                ...
                <div class="panel-body text-right" style="padding-bottom: 0px;">
                    <a onclick="$('#update-categories').toggle()" data-toggle="tooltip" title="<?php echo $button_update_categories; ?>" class="btn btn-success"><i class="fa fa-refresh" aria-hidden="true"></i> <?php echo $button_update_categories; ?></a>
                </div>
                                    ...
                                    <?php foreach ($categories as $category) { ?>
                                        <tr>
                                            ...
                                            <?php if ($category['href']) { ?>
                                                <td class="left"><?php echo $category['indent']; ?><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?> <i class="fa fa-sort-desc"></i></a></td>
                                            <?php } else { ?>
