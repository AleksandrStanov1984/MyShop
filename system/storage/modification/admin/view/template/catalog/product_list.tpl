          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label" for="input-attributes"><?php echo $entry_attributes; ?></label>
                    <select name="filter_attribute" id="input-attributes" class="form-control" />
                        <option value="*"></option>
                        <?php foreach ($fattributes as $attribute) { ?>
          ...
          <div class="table-responsive">
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'pd.name') { ?>
                    ...
                    <?php } ?></td>
                    <td class="text-left"><?php if ($sort == 'p.sort_search') { ?>
                    <a href="<?php echo $sort_search; ?>" class="<?php echo strtolower($order); ?>">Сорт поиска</a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_search; ?>">Сорт поиска</a>
                    <?php } ?></td>
                    <td class="text-left"><?php if ($sort == 'p.sort_order') { ?>
                    <a href="<?php echo $sort_order; ?>" class="<?php echo strtolower($order); ?>">Порядок сортировки</a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_order; ?>">Порядок сортировки</a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $product['sort_search']; ?></td>
