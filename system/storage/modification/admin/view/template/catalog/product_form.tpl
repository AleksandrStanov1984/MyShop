...
<li><a href="#tab-hpmodel" data-toggle="tab"><?php echo $tab_hpm;?></a></li>
            ...
            <li><a href="#tab-samovuvoz" data-toggle="tab">Самовывоз SMARTZONE</a></li>
            <li><a href="#tab-courier" data-toggle="tab">Курьером SMARTZONE</a></li>
            <li><a href="#tab-provider" data-toggle="tab">Поставщик</a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group<?php echo ($hide_upc == true)? ' hide':''; ?>">
                <label class="col-sm-2 control-label" for="input-ean"><span data-toggle="tooltip" title="<?php echo $help_upc; ?>"><?php echo $entry_upc; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-price-base"><?php echo $entry_price_base; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="price_base" value="<?php echo $price_base; ?>" id="input-price-base" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-price_rozetka"><?php echo $entry_price_rozetka; ?></label>
                <div class="col-sm-2">
                  <input type="text" name="price_rozetka" value="<?php echo $price_rozetka; ?>" placeholder="<?php echo $entry_price_rozetka; ?>" id="input-price_rozetka" class="form-control" />
                </div>
                <label class="col-sm-2 control-label" for="input-price_special_rozetka"><?php echo $entry_price_special_rozetka; ?></label>
                <div class="col-sm-2">
                  <input type="text" name="price_special_rozetka" value="<?php echo $price_special_rozetka; ?>" placeholder="<?php echo $entry_price_special_rozetka; ?>" id="input-price_special_rozetka" class="form-control" />
                </div>
              </div>
              <div class="form-group"  style="display:none;">
              ...
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-10">
                  <select data-name="subtract" id="input-subtract" class="form-control">
                    <?php if ($subtract) { ?>
		  ...
		  <input type="hidden" name="subtract" value="0">
 	      ...
 	      <!--<div class="form-group">
                <label class="col-sm-2 control-label" for="input-pot-size"><?php echo $entry_pot_size; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-4">
                      <input type="text" name="diameter_of_pot" value="<?php echo $diameter_of_pot; ?>" placeholder="<?php echo $entry_diameter_of_pot; ?>" id="input-pot-size" class="form-control" />
                    </div>
                    <div class="col-sm-4">
                      <input type="text" name="depth_of_pot" value="<?php echo $depth_of_pot; ?>" placeholder="<?php echo $entry_depth_of_pot; ?>" id="input-pot-depth" class="form-control" />
                    </div>
                  </div>
                </div>
              </div>-->
            	...
            	<div class="form-group">
                <label class="col-sm-2 control-label" for="input-quantity_shelves"><?php echo $entry_quantity_shelves; ?></label>
                <div class="col-sm-10">
                 <input type="text" name="quantity_shelves" value="<?php echo $quantity_shelves; ?>" placeholder="<?php echo $quantity_shelves; ?>" id="input-quantity_shelves" class="form-control" />
                </div>
              </div>
			  	   <div class="form-group">
                <label class="col-sm-2 control-label" for="input-maximum_weight"><?php echo $entry_maximum_weight; ?></label>
                <div class="col-sm-10">
                 <input type="text" name="maximum_weight" value="<?php echo $maximum_weight; ?>" placeholder="<?php echo $maximum_weight; ?>" id="input-maximum_weight" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-maximum_weight_all"><?php echo $entry_maximum_weight_all; ?></label>
                <div class="col-sm-10">
                 <input type="text" name="maximum_weight_all" value="<?php echo $maximum_weight_all; ?>" placeholder="<?php echo $maximum_weight_all; ?>" id="input-maximum_weight_all" class="form-control" />
                </div>
              </div>
             <div class="form-group">
                <label class="col-sm-2 control-label" for="input-material-shelves"><?php echo $entry_material_shelves; ?></label>
                <div class="col-sm-10">
                 <input type="text" name="material_shelves" value="<?php echo $material_shelves; ?>" id="input-material-shelves" class="form-control" />
                </div>
              </div>
              <!--<div class="form-group">
                <label class="col-sm-2 control-label" for="input-model-selection"><?php echo $entry_model_selection; ?></label>
                <div class="col-sm-10">
                 <input type="text" name="model_selection" value="<?php echo $model_selection; ?>" id="input-model-selection" class="form-control" />
                </div>
              </div>
			  	   	<div class="form-group">
                <label class="col-sm-2 control-label" for="input-color_shelves"><?php echo $entry_color_shelves; ?></label>
                <div class="col-sm-10">
                 <input type="text" name="color_shelves" value="<?php echo $color_shelves; ?>" placeholder="<?php echo $color_shelves; ?>" id="input-color_shelves" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-metal_thickness"><?php echo $entry_metal_thickness; ?></label>
                <div class="col-sm-10">
                 <input type="text" name="metal_thickness" value="<?php echo $metal_thickness; ?>" placeholder="<?php echo $metal_thickness; ?>" id="input-metal_thickness" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-type"><?php echo $entry_type; ?></label>
                <div class="col-sm-10">
                 <input type="text" name="type" value="<?php echo $type; ?>" placeholder="<?php echo $type; ?>" id="input-type" class="form-control" />
                </div>
              </div>-->
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-type"><?php echo $entry_series; ?></label>
                <div class="col-sm-10">
                 <input type="text" name="series" value="<?php echo $series; ?>" placeholder="<?php echo $series; ?>" id="input-series" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-type"><?php echo $entry_brand; ?></label>
                <div class="col-sm-10">
                 <input type="text" name="brand" value="<?php echo $brand; ?>" placeholder="<?php echo $brand; ?>" id="input-brand" class="form-control" />
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sort-order">Сортировка поиска. Выше число - первый</label>
                <div class="col-sm-10">
                  <input type="text" name="sort_search" value="<?php echo $sort_search; ?>" placeholder="<?php echo $entry_sort_search; ?>" id="input-sort-order" class="form-control" />
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_visible_carusel; ?></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($visible_carusel) { ?>
                    <input type="radio" name="visible_carusel" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="visible_carusel" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$visible_carusel) { ?>
                    <input type="radio" name="visible_carusel" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="visible_carusel" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
            ...
            <?php if ($privatstatus) { ?>
              <div class="tab-pane" id="tab-privat">
                      <div class="table-responsive">
                        <table id="privatebank" class="table table-bordered table-hover">
                          <thead>
                            <tr>
...
<?php echo $hpm_tab;?>
            <div class="tab-pane" id="tab-attribute">
              <div class="table-responsive">
                <table id="attribute" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-left" style="width: 20%;"><?php echo $entry_attribute; ?></td>
                      <td class="text-left" style="width: 30%;"><?php echo $entry_text; ?></td>
                  ...
                  <?php  $attribute_row = 0; ?>
                    <?php foreach($product_attributes as $product_attribute){ ?>
                      <tr id="attribute-row<?php echo $attribute_row; ?>">
                        <td class="text-left" style="width: 20%;vertical-align: top;">
                            <lable style="font-weight: bold;"><?php echo $product_attribute['name']; ?></lable>
                        </td>
                        
                      <td class="text-left" style="width: 30%;">
                            <div class="attribute_select_list">
                                <input type="text" id="attribute_select_<?php echo $attribute_row; ?>"  data-row="<?php echo $attribute_row; ?>" data-attribute_id="<?php echo $product_attribute['attribute_id']; ?>" placeholder="Выбрать значения" class="attribute_select form-control" style="width: calc(100% - 50px);" />
                                <a href="javascript:;" onClick="reset_attribute_values(<?php echo $product_attribute['attribute_id']; ?>)" data-toggle="tooltip" title="" class="btn btn-info" data-original-title="Сбросить кеш значений"><i class="fa fa-refresh"></i></a>
                                <div id="attribute_select_<?php echo $attribute_row; ?>_list" class="well well-sm" style="height: 150px; overflow: auto;">
                                  <?php foreach(array_shift($product_attribute['values']) as $value_id => $value){ ?>
                                  <div data-value="<?php echo $value_id; ?>"><i class="fa fa-minus-circle"></i> <?php echo $value; ?><?php foreach($product_attribute['values'] as $value_lang){ ?><?php echo isset($value_lang[$value_id]) ? ';'.$value_lang[$value_id] : '<font color="red">!рассинхрон!</font>'; ?><?php } ?></div>
                                  <?php } ?>
                                </div>
                            </div>  
                          ...
                          <!--div class="input-group">
                            ...
                            <select multiple id="attribute_select_<?php echo $attribute_row; ?>" data-attribute_id="<?php echo $product_attribute['attribute_id']; ?>" class="attribute_select form-control">
                                <option value="" selected="selected">-- Выбрать --</option>
                                <?php foreach($product_attribute['values'] as $value_id => $value){ ?>
                                <option value="<?php echo $value_id; ?>" ><?php echo $value[1]; ?></option>
                                <?php } ?>
                            </select>
                          </div--> 
                        </td> 
                        ...
                        <td class="text-left">
                          <?php foreach($languages as $language){ ?>
                            <div class="input-group" id="attribute_text_<?php echo $attribute_row; ?>_<?php echo $language['language_id']; ?>">
                              <span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>"/></span>
                                <textarea name="product_attribute[<?php echo $attribute_row; ?>][product_attribute_description][<?php echo $language['language_id']; ?>][text]"
                                  rows="1" placeholder="<?php echo $entry_text; ?>" class="form-control"><?php echo $product_attribute['product_attribute_description'][$language['language_id']] ? $product_attribute['product_attribute_description'][$language['language_id']]['text'] : ''; ?></textarea>
                            </div>
                          <?php } ?>
                        </td>
                        <td class="text-right">
                          <button type="button" onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();" data-toggle="tooltip"
                                         title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                      </tr>
            ...
            <div class="tab-pane" id="tab-links">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-vendor"><span data-toggle="tooltip" title="" data-original-title="Vendor поставщика">Vendor:</span></label>
                <div class="col-sm-10">
                  <input type="text" name="vendor" value="<?php echo $vendor; ?>" id="input-vendor" class="form-control">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-brend">Вендор</label>
                <div class="col-sm-10">
                  <select id="input-brend" name="brend_id" class="form-control">
                    <option value="0" selected="selected"><?php echo $text_none; ?></option>
                    <?php foreach ($manufacturers as $manufacturer) { ?>
                    <?php if ($manufacturer['manufacturer_id'] == $manufacturer_id) { ?>
                    <option value="<?php echo $manufacturer['manufacturer_id']; ?>" selected="selected"><?php echo $manufacturer['name']; ?></option>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-related"><span data-toggle="tooltip" title="<?php echo $help_related; ?>"><?php echo $entry_related; ?></span><?php echo $entry_related_info; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="related" value="" placeholder="<?php echo $entry_related; ?>" id="input-related" class="form-control" />
                  <div id="product-related" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($product_relateds as $product_related) { ?>
                    <div id="product-related<?php echo $product_related['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_related['name'].' | '.$product_related['model']; ?>
                      <?php if($product_related['sku']) { ?>
                        <?php echo ' / '.$product_related['sku']; ?>
                      <?php } ?>
                      <?php echo $product_related['height'].'x'.$product_related['width'].'x'.$product_related['length']; ?>
            ...
            <div class="tab-pane" id="tab-video">
              <ul class="nav nav-tabs" id="language-video">
                <?php foreach ($languages as $language) { ?>
                <li><a href="#language-video<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                <?php } ?>
              </ul>
              <div class="tab-content">
                <?php $video_row = 0; ?>
                <?php foreach ($languages as $language) { ?>
                <div class="tab-pane" id="language-video<?php echo $language['language_id']; ?>">
                  <table id="videos<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        <td class="text-left"><?php echo $entry_video_title; ?></td>
                        <td class="text-left"><span data-toggle="tooltip" title="<?php echo $help_video; ?>"><?php echo $entry_video_link; ?></span></td>
                        <td class="text-right"><?php echo $entry_sort_order; ?></td>
                        <td></td>
                      </tr>
                    </thead>
                    <tbody>
                      <?php if (isset($videos[$language['language_id']])) { ?>
                      <?php foreach ($videos[$language['language_id']] as $video_data) { ?>
                      <tr id="video-row<?php echo $video_row; ?>">
                        <td class="text-left"><input type="text" name="videos[<?php echo $language['language_id']; ?>][<?php echo $video_row; ?>][name]" value="<?php echo $video_data['name']; ?>" placeholder="<?php echo $entry_video_title; ?>" class="form-control" />
                        </td>
                        <td class="text-left" style="width: 30%;"><input type="text" name="videos[<?php echo $language['language_id']; ?>][<?php echo $video_row; ?>][video]" value="<?php echo $video_data['video']; ?>" placeholder="<?php echo $entry_video_link; ?>" class="form-control" /></td>
                        <td class="text-right" style="width: 10%;"><input type="text" name="videos[<?php echo $language['language_id']; ?>][<?php echo $video_row; ?>][sort_order]" value="<?php echo $video_data['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>
                        <td class="text-left"><button type="button" onclick="$('#video-row<?php echo $video_row; ?>, .tooltip').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                      </tr>
                      <?php $video_row++; ?>
                      <?php } ?>
                      <?php } ?>
                    ...
                    <tfoot>
                      <tr>
                        <td colspan="3"></td>
                        <td class="text-left"><button type="button" onclick="addVideo('<?php echo $language['language_id']; ?>');" data-toggle="tooltip" title="<?php echo $button_video_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                      </tr>
                    </tfoot>
                  </table>
                </div>
            ...
            <div class="tab-pane" id="tab-image">
              <div class="table-responsive">
                ...
                <table class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-left"><?php echo $entry_image_dod; ?></td>
                  </tr>
                  </thead>

                  <tbody>
                  <tr>
                    <td class="text-left"><a href="" id="thumb-image-dod" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_dod; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="image_dod" value="<?php echo $image_dod; ?>" id="input-image-dod" /></td>
                  </tr>
                  </tbody>
                </table>
            ...
            <!--samovuvoz-->
            <div class="tab-pane" id="tab-samovuvoz">
              <div class="form-group">
                <label class="col-sm-2 control-label">Самовывоз</label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($pickup) { ?>
                    <input type="radio" name="pickup" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                  ...
                  <label class="radio-inline">
                    <?php if (!$pickup) { ?>
                    <input type="radio" name="pickup" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="min-height: 150px;max-height: 500px;overflow: auto;">
                    ...
                    <div class="checkbox">
                        <?php if (in_array($city['name'], $product_pickup_city)) { ?>
                        <label>
                        <input type="checkbox" name="product_pickup_city[]" value="<?php echo $city['name']; ?>" checked/>
                        <?php echo $city['name']; ?>
                         </label>
                        <?php }else{ ?>
                      <label>
                        <input type="checkbox" name="product_pickup_city[]" value="<?php echo $city['name']; ?>" />
                        <?php echo $city['name']; ?>
                      </label>
                        <?php } ?>
                    </div>
            ...
            <div class="tab-pane" id="tab-courier">
              <div class="form-group">
                <label class="col-sm-2 control-label">Курьером</label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($courier) { ?>
                    <input type="radio" name="courier" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                  ...
                  <label class="radio-inline">
                    <?php if (!$courier) { ?>
                    <input type="radio" name="courier" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="courier" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="min-height: 150px;max-height: 500px;overflow: auto;">
                    <?php foreach ($citys as $city) { ?>
                    <div class="checkbox">
                      <?php if (in_array($city['name'], $product_courier_city)) { ?>
                      <label>
                        <input type="checkbox" name="product_courier_city[]" value="<?php echo $city['name']; ?>" checked/>
                        <?php echo $city['name']; ?>
                      </label>
                      <?php }else{ ?>
                      <label>
                        <input type="checkbox" name="product_courier_city[]" value="<?php echo $city['name']; ?>" />
                        <?php echo $city['name']; ?>
                      </label>
                      <?php } ?>
                    </div>
            ...
            <div class="tab-pane" id="tab-provider">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-category">Поставщик</label>
                <div class="col-sm-10">
                  <div class="well well-sm" style="min-height: 150px;max-height: 500px;overflow: auto;">
                    <?php foreach ($providers as $provider) { ?>
                    <div class="checkbox">
                      <?php if ($provider['id_provider'] == $provider_product) { ?>
                      <label>
                        <input type="radio" name="provider_product" value="<?php echo $provider['id_provider']; ?>" checked/>
                        <?php echo $provider['name']; ?>
                      </label>
                      <?php }else{ ?>
                      <label>
                        <input type="radio" name="provider_product" value="<?php echo $provider['id_provider']; ?>" />
                        <?php echo $provider['name']; ?>
                      </label>
                      <?php } ?>
                    </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-nomer_provider_product">Номер продукта поставщика</label>
                <div class="col-sm-10">
                  <input type="text" name="nomer_provider_product" value="<?php echo $nomer_provider_product; ?>" placeholder="номер продукта поставщика" id="input-nomer_provider_product" class="form-control" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="price_base" value="<?php echo $price_base; ?>" placeholder="price_base" id="input-price_base" class="form-control" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="price_rrc" value="<?php echo $price_rrc; ?>" placeholder="price_rrc" id="input-price_rrc" class="form-control" />
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-name_provider_product">name_provider_product</label>
                <div class="col-sm-10">
                  <input type="text" name="name_provider_product" value="<?php echo $name_provider_product; ?>" placeholder="name_provider_product" id="input-name_provider_product" class="form-control" />
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-day_delivery">day_delivery</label>
                <div class="col-sm-10">
                  <input type="text" name="day_delivery" value="<?php echo $day_delivery; ?>" placeholder="day_delivery" id="input-day_delivery" class="form-control" />
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-delivery">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-np_branch"><?php echo $entry_np_branch; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="np_branch" value="<?php echo $np_branch; ?>" placeholder="<?php echo $entry_np_branch; ?>" id="input-np_branch" class="form-control" />
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-np_courier"><?php echo $entry_np_courier; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="np_courier" value="<?php echo $np_courier; ?>" placeholder="<?php echo $entry_np_courier; ?>" id="input-np_courier" class="form-control" />
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-np_sz_courier"><?php echo $entry_np_sz_courier; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="np_sz_courier" value="<?php echo $np_sz_courier; ?>" placeholder="<?php echo $entry_np_sz_courier; ?>" id="input-np_sz_courier" class="form-control" />
                </div>
              </div>
            </div>
            <!--Delivery-->
  ...
  function reset_attribute_values(attribute_id){
    $.ajax({
      url: 'index.php?route=catalog/attribute/delete_attribute_values&token=<?php echo $token; ?>&attribute_id=' +  encodeURIComponent(attribute_id),
      dataType: 'text',
      success: function(json) {
        console.log('reset_attribute_values'+json);
      }
    }); 
  }
  
  function attributeautocomplete_values() {
      $('input.attribute_select').autocomplete({
        'source': function(request, response) {
          
          var attribute_id = $(this).data('attribute_id');
          
          $.ajax({
            url: 'index.php?route=catalog/attribute/autocomplete_values&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request) + '&attribute_id=' +  encodeURIComponent(attribute_id),
            dataType: 'json',
            success: function(json) {
        ...
        'select': function(item) {
          $('input.attribute_select').val('');
          var row = $(this).data('row');
         
          $('#attribute_select_'+row+'_list').append('<div data-value="'+item['value']+'"><i class="fa fa-minus-circle"></i> '+item['label']+'</div>');
          
          reload_attribute_row(row);
          
        }  
      });
   
      $('.attribute_select_list').delegate('.fa-minus-circle', 'click', function() {
        var row = $(this).parents('tr').attr('id');
        row = row.replace('attribute-row', '');
        $(this).parent().remove();
        reload_attribute_row(row);
      });
   }
   
  attributeautocomplete_values();
  
   
  function reload_attribute_row(row){
    
    $('#attribute-row'+row+' textarea').html('');
    
    $( "#attribute_select_"+row+"_list div" ).each(function( index ) {
      var str = $( this ).html();
      str = str.replace(/(<([^>]+)>)/ig,"");
      arr = str.split(";");
      
      $(arr).each(function(ind, value) {
        var text = $('#attribute-row'+row+' textarea:eq('+(ind)+')').html();
        $('#attribute-row'+row+' textarea:eq('+(ind)+')').html(text+$.trim(value)+';');
      });
...
function addAttribute() {
	...
	html += '  <td class="text-left" style="width: 30%;"><div class="attribute_select_list">';
  html += '     <input type="text" id="attribute_select_' + attribute_row + '" data-row="' + attribute_row + '" data-attribute_id="15" placeholder="Выбрать значения" class="attribute_select form-control" autocomplete="off"><ul class="dropdown-menu"></ul>';
  html += '     <div id="attribute_select_' + attribute_row + '_list" class="well well-sm" style="height: 150px; overflow: auto;"></div>';
  html += '  </div></td>';
  
  html += '  <td class="text-left">';
	<?php foreach ($languages as $language) { ?>
	html += '<div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span><textarea rows="1" name="product_attribute[' + attribute_row + '][product_attribute_description][<?php echo $language['language_id']; ?>][text]" rows="5" placeholder="<?php echo $entry_text; ?>" class="form-control"></textarea></div>';
    <?php } ?>
	html += '  </td>';
  ...
  attributeautocomplete_values(attribute_row);
...
function attributeautocomplete(attribute_row) {
	$('input[name=\'product_attribute[' + attribute_row + '][name]\']').autocomplete({
		...
		'select': function(item) {
			...
			$('#attribute_select_' + attribute_row).data('attribute_id', item['value']);
		}
	});
}
...
$('input[name=\'related\']').autocomplete({
    ...
    html = '';
    html += '<div id="product-related' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'];
    html += ' | ' + item['model'];
    if(item['sku']) {
      html += ' / ' + item['sku'];
    }

    html += ' / '+item['height']+'x'+item['width']+'x'+item['length'];
    html += '<input type="hidden" name="product_related[]" value="' + item['value'] + '" /></div>';
...
<script type="text/javascript"><!--
  ...
  function addVideo(language_id) {
    html  = '<tr id="video-row' + video_row + '">';
      html += '  <td class="text-left"><input type="text" name="videos[' + language_id + '][' + video_row + '][name]" value="" placeholder="<?php echo $entry_video_title; ?>" class="form-control" /></td>';  
    html += '  <td class="text-left" style="width: 30%;"><input type="text" name="videos[' + language_id + '][' + video_row + '][video]" value="" placeholder="<?php echo $entry_video_link; ?>" class="form-control" /></td>';  
    html += '  <td class="text-right" style="width: 10%;"><input type="text" name="videos[' + language_id + '][' + video_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
    html += '  <td class="text-left"><button type="button" onclick="$(\'#video-row' + video_row  + ', .tooltip\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
    html += '</tr>';
    
    $('#videos' + language_id + ' tbody').append(html);
    
    video_row++;
  }
  //--></script> 
    <script type="text/javascript"><!--
  $('#language-video a:first').tab('show');
  //--></script> 
  <script type="text/javascript"><!--
