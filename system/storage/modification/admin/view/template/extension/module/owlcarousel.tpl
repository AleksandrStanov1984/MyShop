            ...
            <div class="tab-pane active" id="tab-settings">
              <div class="tab-pane">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="subtitle-<?php echo $language['language_id']; ?>">Заголовок 2</label>
                    <div class="col-sm-10">
                      <input type="text" name="owlcarousel_module[subtitle][<?php echo $language['language_id']; ?>]" id="subtitle-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['subtitle'][$language['language_id']]) ? $module['subtitle'][$language['language_id']] : ''; ?>" class="form-control" />
                    </div>
                  </div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">Порядок сортировки (для табов)</label>
                    <div class="col-sm-10">
                      <input type="text" name="owlcarousel_module[sort_order_tabs]" value="<?php echo isset($module['sort_order_tabs']) ? $module['sort_order_tabs'] : 0; ?>" class="form-control" />
                    </div>
                </div>
...
<?php if ($module['sort'] == 'random') { ?>
                    <option value="random" selected="selected"><?php echo $text_sort_random; ?></option>
                    <?php } else { ?>
                    <option value="random"><?php echo $text_sort_random; ?></option>
                    <?php } ?>
            ...
            <div class="tab-pane" id="tab-display">
              ...
              <div class="form-group">
                ...
                <?php foreach ($other_modules as $other) { ?>
                  ...
                  <div class="col-sm-4"><?php echo isset($other['sort_tabs']) ? $other['sort_tabs'] : 0 ?></div>
