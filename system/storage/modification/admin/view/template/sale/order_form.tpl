        ...
        <form class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-total">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sendsms"><?php echo $entry_sendsms; ?></label>
                <div class="col-sm-10">
                    <select name="sendsms" id="input-send-sms" class="form-control">
                ...
                <?php }else{ ?>
                    <input type="hidden" name="admin_order" value="0" />
                <?php } ?>
              </div>
...
$('#button-save').on('click', function() {
	...
	$.ajax({
		url: url,
		type: 'post',
		data: $('select[name=\'payment_method\'] option:selected,  select[name=\'shipping_method\'] option:selected,  #tab-total select[name=\'order_status_id\'],  #tab-total select[name=\'sendsms\'] option:selected, input[name=\'admin_order\'], #tab-total select, #tab-total textarea[name=\'comment\'], #tab-total input[name=\'affiliate_id\']'),
		beforeSend: function() {
