...
//print_r($product_discount_query);
				...
				if (!$this->config->get('creditprivat_status')) {
					if (isset ($this->session->data['payment_method']['code'])) {
						if ($this->session->data['payment_method']['code'] == 'privatbank_paymentparts_pp') {
							$privat_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_privat WHERE product_id = '" . (int)$product_query->row['product_id'] . "'");
				...
				$product_data[] = array(
                'base_price'         => isset($base_price)?$base_price:false,
					...
					'stock'           => $stock,
					'price'           => ($price + $option_price) * $markup,
					'total'           => ($price + $option_price) * $markup * $cart['quantity'],
					...
					'diameter_of_pot' => $product_query->row['diameter_of_pot'],
					'depth_of_pot' => $product_query->row['depth_of_pot'],
					'length_class_id' => $product_query->row['length_class_id'],
					'recurring'       => $recurring,
                    'np_branch'       => $product_query->row['np_branch'],
                    'np_courier'      => $product_query->row['np_courier'],
                    'np_sz_courier'   => $product_query->row['np_sz_courier']
				);
			} else {
