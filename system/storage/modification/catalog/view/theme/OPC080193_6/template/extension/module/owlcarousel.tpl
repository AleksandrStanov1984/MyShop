        ...
        <div class="tab-pane-carousel <?php echo $key?> <?php echo $key == 0 ? 'active': ''; ?> catalog-mobile block-products" id="tab-carousel-<?php echo $m['module']; ?>">
            <div class="">
                ...
                <div class="title-carousel-product h2-title title-section-mob <?php echo count($modules) > 1 ? 'tilte-tab-home' : 'tilte-view-home'; ?> ">
                    ...
                    <span><?php if (count($modules) > 1) { ?><span class="popular-title-tab title-first-cell hidden-sm hidden-md hidden-lg"><?php echo $m['subtitle'] ? $m['subtitle'].' /' : ''; ?></span><?php }?><span class="title-second-cell"> <?php echo $m['heading_title']; ?></span></span><?php if($m['link_see_all']){ ?><a class=" show-full" href="<?php echo $m['link_see_all']; ?>"><?php echo $text_see_all; ?></a><?php } ?>
                </div>
                ...
                <div id="owl-<?php echo $m['module']; ?>" class="owl-carousel owl-moneymaker2 slider-popular cat__slider-products" >
                    ...
                    <div data-product-id="<?php echo $product['product_id']; ?>" class="item " style="height: 100%;" >
                        <div class="image">
                            <a class="lazy-link" href="<?php echo $product['href']; ?>" data-hpm-href="1"><img  style="width: 162px"  data-src="<?php echo $product['thumb'] ? $product['thumb'] : HTTP_SERVER . 'image/no_image.png' ; ?>" src="image/loader-gray.gif" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive lazy-sz"/></a>
                        </div>
...
<div class="novelties-tab-container">
    <div class="tabs-carousel" id="nav-carousel-<?php echo $module; ?>">
        <div data-product-id="<?php echo $product['product_id']; ?>" class="item  j-novelties-switcher">
            <?php $is_first_tab = true; ?>
            <?php foreach ($modules as $key => $m) {?>
            <?php if ($m['products']) { ?>
