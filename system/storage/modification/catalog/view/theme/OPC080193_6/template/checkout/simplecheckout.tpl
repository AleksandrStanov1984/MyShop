...
<div class="continue-shopping">
    <a class="btn-big btn btn-continue" href="/"><?php echo $button_continue; ?></a>
</div> 
<?php } ?>
            <?php if (!$cart_empty) { ?>
                ...
                <?php
                    $replace = array(
                        ...
                        '{cart}'             => $simple_blocks['cart'].'<div class="header-simplecheckout-cart">'.$title_block_checkout. '</div><div class="simple-header-description">'.$description_block_checkout. '</div>',
                ...
                <div class="simplecheckout-button-block buttons" id="buttons">
                    <div class="simplecheckout-button-right">
                        ...
                        <?php } ?>
                        <span class="inputs buttons"> <a class="btn-big btn" <?php echo $block_order ? 'disabled' : '' ?> data-onclick="createOrder" id="simplecheckout_button_confirm"><?php echo $button_order; ?></a> </span>
                ...
                <?php } ?>              
            <?php } else { ?>
                <div class="content text-cart-empty"><?php echo $text_error; ?></div>
                ...
                <div class="simplecheckout-button-block buttons">
                    <div class="simplecheckout-button-right right continue-cart-empty"><a href="<?php echo $continue; ?>" class="button btn-primary button_oc btn"><span><?php echo $button_continue; ?></span></a></div>
                </div>
            <?php } ?>
        </div>
    </div>
<script>
$('#privatbank_paymentparts_ii').parent().after('<div id="ii" style="display:inline-block"></div>');
if ($("#privatbank_paymentparts_ii").prop("checked")) {
    $('#ii').load('index.php?route=extension/module/creditsimpleii', function(){$('#activatescript').trigger('click');});
}

$('#privatbank_paymentparts_pp').parent().after('<div id="pp" style="display:inline-block"></div>');
if ($("#privatbank_paymentparts_pp").prop("checked")) {
    $('#pp').load('index.php?route=extension/module/creditsimplepp', function(){$('#activatescript').trigger('click');});
}
</script>
<?php if (!$ajax && !$popup && !$as_module) { ?>
</div>
