...
class ControllerCheckoutSimpleCheckout extends SimpleController {
    ...
    public function index($args = null) {
        ...
        $this->_templateData['title_block_checkout']    = $this->language->get('title_block_checkout');
        $this->_templateData['description_block_checkout']    = $this->language->get('description_block_checkout');
       ...
       // $this->document->addScript('catalog/view/javascript/jquery/pp_calculator/calculator.js');
    ...
    private function order() {
		...
		// NEON: Attach COUPON to PICKUP shipment
		$couponCode = "";
		...
		if($this->session->data['shipping_method']['code'] == 'pickup.pickup') {
			$productPickupPointId = $customInfo['shipping_field20'];
			$couponCode = $this->model_extension_total_coupon->getProductPickupPointCoupon($productPickupPointId);
			$productPickupPointAddress = $this->model_extension_total_coupon->getProductPickupPoint($productPickupPointId);
			$payment_address['city'] = $productPickupPointAddress;
			$shipping_address['city'] = $productPickupPointAddress;			
		}
