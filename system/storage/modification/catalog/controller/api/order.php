		...
		if (!isset($this->session->data['api_id'])) {
			...
			if ($order_info) {
				...
				if (!$json) {
                    ...
                    $this->model_checkout_order->addOrderHistory($order_id, $order_status_id, $order_data['comment'], '', '', $this->request->post['sendsms'], false);
	...
	public function history() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if ($order_info) {
				...
				$this->model_checkout_order->addOrderHistory($order_id, $this->request->post['order_status_id'], $this->request->post['comment'], $this->request->post['notify'], $this->request->post['override'], $this->request->post['sendsms'], false);
