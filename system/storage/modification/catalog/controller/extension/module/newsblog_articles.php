...
class ControllerExtensionModuleNewsBlogArticles extends Controller {
	...
	public function index($setting) {
	    /*gulp add */
		//$this->document->addStyle('catalog/view/theme/OPC080193_6/stylesheet/module_newsblog_article.css');
        $this->document->addStyle('catalog/view/theme/OPC080193_6/assets/module_newsblog_article.css');
        /*gulp add */
