...
#tmd_delivery_address{
	padding:10px;margin:15px 0;background:<?php echo $tmdqc_sub_content_background; ?>;border:1px solid <?php echo $tmdqc_sub_content_border; ?>;
}
...
#tmd_cart .form-control{height:32px;}
