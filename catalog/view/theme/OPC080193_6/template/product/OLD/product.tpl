...
<?php echo $column_left; ?>
		<?php /*<div class="product-info-item benefits">
		    <div class="item item-1">Нагрузка до 1080 кг</div>
		    <div class="item item-3">Гарантия 2 года</div>
		    <div class="item item-2">Размеры 180x90x45 см</div>
		    <!--<div class="item item-4">Регулируемая высота полок</div>-->
		</div>
		<div class="product-info-item delivery">
		    <div class="name">Доставка</div>
		    <div class="info-item">Новая Почта</div>
		    <span>- до отделения: <b>100 грн</b></span>
		    <span>- по адресу: <b>120 грн</b></span>
		</div>
		<div class="product-info-item payment">
		    <div class="name">Оплата</div>
		    <div class="info-item item-1">Приват24</div>
		    <span><b>комиссия 1%</b></span>
		    <div class="info-item item-2">Наложенный платеж</div>
		    <span><b>35 грн</b></span>
		</div>
		<div class="button"><a href="#" class="more-link">Подробнее о доставке и оплате</a></div>
*/?>
	    </div>
	</div>
    </div>
...
<section class="product-tabs">
	...
	<div class="present-mobile-col">
		...
		<div class="name">
		    <b>В подарок</b>
		    набор для сборки и монтажа
		</div>
		<div class="list">
		    <div class="item item-1">Перчатки - <i>1 пара</i></div>
		    <div class="item item-2">Молоточек - <i>1 шт.</i></div>
		    <div class="item item-3">Отвертка двусторонняя</div>
		    <div class="item item-4">Крепеж (винт + гайка-барашек) для стягивания стеллажей между собой - <i>4 комплекта</i></div>
		    <div class="item item-5">Дюбель-гвоздь 8х60 (для крепления стоек стеллажа в верхних точках к стене) - <i>2 шт.</i></div>
		    <div class="item item-6">Инструкция - <i>1 шт.</i></div>
		</div>
	    </div>*/?>
