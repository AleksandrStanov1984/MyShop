...
<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="catalog/view/theme/<?php echo $mytemplate; ?>/css/slick.css?ver1.193" />
    ...
    <link rel="stylesheet" type="text/css" href="catalog/view/theme/<?php echo $mytemplate; ?>/css/remodal.css?ver1.193" />
    <link rel="stylesheet" type="text/css" href="catalog/view/theme/<?php echo $mytemplate; ?>/css/remodal-default-theme.css" />
    <link rel="stylesheet" type="text/css" href="catalog/view/theme/<?php echo $mytemplate; ?>/css/style.css?ver1.193" />
...
<script type="text/javascript" src="catalog/view/theme/<?php echo $mytemplate; ?>/js/jquery-1.11.0.min.js"></script>
    ...
    <script type="text/javascript" src="catalog/view/theme/<?php echo $mytemplate; ?>/js/scripts.js?ver1.24"></script>
...
<?php echo $language; ?>
    ...
    <div id="ajax_preloader">
        ...
        <div class="remodal-wrapper remodal-is-opened" style="display: block;" id="wraper-popup">
            <div class="ajax_block"><img width="50" height="50" src="image/loader2.gif"/></div>    
        </div>
    </div>
