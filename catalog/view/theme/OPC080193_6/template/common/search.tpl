<div class="header-search">
  <div class="search-form">
    <div id="search" class="search-wrap">
      <input name="search" class="search-input" value="<?php echo $search; ?>" placeholder="<?php echo $text_search; ?>" type="text">

        <div class="search-close"><img src="catalog/view/theme/<?php echo $mytemplate; ?>/images/ico-close.svg" alt="search close" /></div>
