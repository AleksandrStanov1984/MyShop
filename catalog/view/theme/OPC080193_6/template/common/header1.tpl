...
<header>
  <div class="container">
    <div class="row">
	<div class="col-lg-4 col-md-4 hidden-xs hidden-sm header-adress">
		<div style="float: left">
			<i class="fa fa-envelope"></i><?php echo $type_us; ?>
			<span><a title="Написать в Viber" href="viber://chat?number=+380676208833">Viber <img class="head-phone" title="Viber" height="16" src="/catalog/view/theme/OPC080193_6/image/viber_logo.png"></a></span>
			<span><a title="Написать в Telegram" href="tg://resolve?domain=@sz_ua">Telegram <img class="head-phone" title="Telegram" height="16" src="/catalog/view/theme/OPC080193_6/image/telegram_logo.png"></a></span>
		</div>
	</div>
      <div class="col-lg-4 col-md-4 col-xs-12 header-logo">
        <div id="logo">
          <?php if ($logo) { ?>
	  ...
	  <div class="col-lg-4 col-md-4 hidden-xs hidden-sm header-phone">
		<div style="float: right">
			<i class="fa fa-phone"></i><?php echo $call_us; ?>
			<span><?php echo $telephone; ?></span>
			<span>(044) 499 76 68</span>
		</div>
	  </div>
	  <div class="header-right">
	  <div class="header-right-container">
	  <div class="fixed-phone hidden-sm "><i class="fa fa-phone"></i> <span><a href="tel:<?php echo $telephone; ?>" title="<?php echo $call_us; ?>"><?php echo $telephone; ?></a></span></div>
