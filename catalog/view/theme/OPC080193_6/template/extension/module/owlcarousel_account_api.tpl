                ...
                <div id="owl-<?php echo $m['module']; ?>" class="owl-carousel slider-popular cat__slider-products" style="display: flex;">
                  <?php foreach ($m['products'] as $product) { ?>
                    <div class="item">
                      ...
                      <div class="image"><a href="<?php echo $product['href']; ?>"><img  src="<?php echo $product['image'] ? $product['image'] : HTTP_SERVER . 'image/no_image.png' ; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive" /></a></div>
