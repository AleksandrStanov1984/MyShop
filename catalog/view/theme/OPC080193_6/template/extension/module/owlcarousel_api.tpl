                ...
                <div id="owl-<?php echo $m['module']; ?>" class="owl-carousel owl-moneymaker2 slider-popular cat__slider-products" >
                  <?php foreach ($m['products'] as $product) { ?>
                    <div class="item" style="height: 100%;" >
                      <div class="image">
                        <a href="<?php echo $product['href']; ?>"><img  style="width: 162px" src="<?php echo $product['image'] ? $product['image'] : HTTP_SERVER . 'image/no_image.png' ; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive lazy-sz"/></a>
                      </div>
