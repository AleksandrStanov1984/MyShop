            ...
            <div class="">
                ...
                <div id="owl-<?php echo $m['module']; ?>" class="owl-carousel owl-moneymaker2 slider-popular cat__slider-products" >
                    ...
                    <div data-product-id="<?php echo $product['product_id']; ?>" class="item " style="height: 100%;" >
                        <div class="image">
                            <a class="lazy-link" href="<?php echo $product['href']; ?>"><img  style="width: 162px"  data-src="<?php echo $product['thumb'] ? $product['thumb'] : HTTP_SERVER . 'image/no_image.png' ; ?>" src="image/loader-gray.gif" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive lazy-sz"/></a>
                        </div>
