...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="http://www.sz.ua/image/catalog/sz-logo_small.png" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  ...
  <?php if ($qr) {?>
  	<p style="margin-top: 0px; margin-bottom: 20px;">
		<img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=https%3A%2F%2Fwww.sz.ua%2Frd%2F<?php echo $qr; ?>&choe=UTF-8" title="SZ.UA" />
	</p>
  <?php } ?>
