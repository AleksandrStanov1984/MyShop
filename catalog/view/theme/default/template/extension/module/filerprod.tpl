        ...
        <div class="item">
            ...
            <div class="text-left name">
                <a href="<?php echo $product['href'] ?>">
                    ...
                    <div class="shelf-mobile2"><span class="shelf_txt">На стеллаж: </span> <span class="shelf_qty"><?php echo $product['maximum_weight_all']; ?></span><span class="shelf_txt">&nbsp;кг</span></div>
