                    ...
                    <div class="col-lg-12 item">
                        <div class="product-thumb transition">
                            <?php if ($product['thumb']) { ?>
                                <div class="image">
                                    <a href="<?php echo $product['href']; ?>"><img <?php if ($m['show_lazy_load'] == 1) { ?>data-<?php } ?>src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" class="img-responsive <?php if ($m['show_lazy_load'] == 1) { ?>lazyOwl<?php } ?>"/></a>
                                </div>
                            <?php } ?>
                            <div class="caption">
