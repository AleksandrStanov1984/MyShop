                    ...
                    <td class="quantity">
                        <div class="input-group btn-block" style="max-width: 200px;">
                            <span class="input-group-btn">
                                <button class="count-minus spin-plus" data-onclick="decreaseProductQuantity" data-toggle="tooltip" type="submit">
                            ...
                            <span class="input-group-btn">
                                <button class="count-plus spin-plus" data-onclick="increaseProductQuantity" data-toggle="tooltip" type="submit">
...
<?php if (isset($modules['coupon']) || (isset($modules['reward']) && $points > 0) || isset($modules['voucher'])) { ?>
    <div class="simplecheckout-cart-total simplecheckout-cart-buttons">
        <span class="inputs buttons"><a id="simplecheckout_button_cart" data-onclick="reloadAll" class="btn-big btn"><?php echo $button_update; ?></a></span>
    </div>
<?php } ?>
