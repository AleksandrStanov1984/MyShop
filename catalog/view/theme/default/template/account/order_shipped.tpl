  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="buttons clearfix">
        <div class="pull-right"><a href="https://www.sz.ua/index.php?route=account/order/ship&order_id=<?php echo $encyptedOrderId; ?>" class="btn btn-primary"><?php echo $button_continue; ?></a></div>
      </div>
