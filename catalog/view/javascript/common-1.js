...
$(document).ready(function() {
	...
	if(window.matchMedia('(max-width: 767px)').matches){
		$('.panel-sfv-catalogs .view .img-view-prod').attr('src', 'catalog/view/theme/OPC080193_6/images/view-foto.svg');
	...
	$('#grid-view').click(function() {
		...
		if (cols == 2) {
			...
			$('#content .product-layout').attr('class', 'product-layout product-grid col-lg-4 col-md-6 col-sm-6 col-xs-6');
		} else {
		...
		if(window.matchMedia('(max-width: 767px)').matches){
		$('.panel-sfv-catalogs .view .img-view-prod').attr('src', 'catalog/view/theme/OPC080193_6/images/view-grid.svg');
	...
	$('#photo-view').click(function() {
		$('#content .product-grid > .clearfix').remove();
		$('#content .row > .product-layout').attr('class', 'product-layout product-photo col-xs-12');
		$('#grid-view').removeClass('active');
		$('#list-view').removeClass('active');
		$('#photo-view').addClass('active');
		
		if(window.matchMedia('(max-width: 767px)').matches){
		$('.panel-sfv-catalogs .view .img-view-prod').attr('src', 'catalog/view/theme/OPC080193_6/images/view-list.svg');
		$('#modal-view-product .view-ul li').removeClass('active');
		$('#modal-view-product #view-list-fake').addClass('active');
		}
...
if(window.matchMedia('(max-width: 767px)').matches){
	...
	if (sessionStorage.getItem('display') == 'list') {
		$('#list-view').addClass('active');
		$('#modal-view-product #view-foto-fake').addClass('active');
		$('.panel-sfv-catalogs .view .img-view-prod').attr('src', 'catalog/view/theme/OPC080193_6/images/view-foto.svg');
		$('.panel-sfv-catalogs .view .img-view-prod').css('display','block');
	//} else if(localStorage.getItem('display') == 'grid'){
	} else if(sessionStorage.getItem('display') == 'grid'){
	...
	if (sessionStorage.getItem('display') == 'list') {
		$('#grid-view').trigger('click');
		$('#grid-view').addClass('active');
	//} else if(localStorage.getItem('display') == 'photo'){	
	} else if(sessionStorage.getItem('display') == 'photo'){
		$('#grid-view').trigger('click');
		$('#grid-view').addClass('active');
