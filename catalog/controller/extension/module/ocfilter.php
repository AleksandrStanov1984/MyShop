...
class ControllerExtensionModuleOCFilter extends Controller {
  ...
  public function initialise() {
    ...
    if ($this->config->get('ocfilter_show_selected') && $this->options_get) {
     ...
     //$this->document->addStyle('catalog/view/theme/OPC080193_6/stylesheet/ocfilter/ocfilter.css?ver2.1');
     ...
     //$this->document->addScript('catalog/view/javascript/ocfilter/ocfilter.js');
        $this->document->addStyle('catalog/view/theme/OPC080193_6/assets/nouislider.min.css');
        $this->document->addStyle('catalog/view/theme/OPC080193_6/assets/ocfilter.css?ver2.2');
        $this->document->addScript('catalog/view/theme/OPC080193_6/assets/nouislider.min.js');
        $this->document->addScript('catalog/view/theme/OPC080193_6/assets/ocfilter.js');
        /* gulp add */
