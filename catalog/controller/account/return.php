...
class ControllerAccountReturn extends Controller {
	...
	public function add() {
		...
		$data['text_request_return'] = $this->language->get('text_request_return');
		$data['text_conditions_return'] = $this->language->get('text_conditions_return');
		$data['text_conditions_instruction'] = $this->language->get('text_conditions_instruction');
		$data['text_question_answer'] = $this->language->get('text_question_answer');
		$data['text_recipient'] = $this->language->get('text_recipient');
		$data['text_recipient_value'] = $this->language->get('text_recipient_value');
		$data['text_delivery_type'] = $this->language->get('text_delivery_type');
		$data['text_delivery_type_value'] = $this->language->get('text_delivery_type_value');
		$data['text_address'] = $this->language->get('text_address');
		$data['text_address_value'] = $this->config->get('config_address');
		$data['text_services'] = $this->language->get('text_services');
		$data['text_services_value'] = $this->language->get('text_services_value');
		...
		$data['link_term_return'] = $this->url->link('information/information', 'information_id=27');
		$data['link_manual_return'] = $this->url->link('information/information', 'information_id=28');
		$data['question_answer_return'] = $this->url->link('information/information', 'information_id=29');


		$data['return_link'] = $this->url->link('account/return');
		$data['about'] = $this->url->link('information/about');


		$data['button_submit'] = $this->language->get('button_submit');
		$data['button_back'] = $this->language->get('button_back');
		$data['text_send_requisites'] = $this->language->get('text_send_requisites');
