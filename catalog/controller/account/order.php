    ...
    $data['button_ocstore_yk_onpay'] = $this->language->get('button_ocstore_yk_onpay');
		...
		foreach ($results as $result) {
			...
			$data['orders'][] = array(
				...
				'products'   => $products,
				'products_qnt_mob'   => sprintf($this->language->get('text_qnt_order_mob'), ($product_total + $voucher_total)),
				'products_qnt'   => sprintf($this->language->get('text_qnt_order'), ($product_total + $voucher_total)),
