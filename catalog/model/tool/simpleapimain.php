...
class ModelToolSimpleApiMain extends Model {
    ...
    public function getDefaultEmail() {
        ...
        $email = $this->model_account_customer->getCustomerEmail($customer_id);
        if($customer_id && $this->model_account_customer->getCustomerEmail($customer_id)) {
            if(stristr($email, 'localhost') === FALSE) return $email; else return '';
        } else {
            return '';
        }
