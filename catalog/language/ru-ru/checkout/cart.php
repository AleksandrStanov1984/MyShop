...
$_['text_success']             = 'Товар добавлен в корзину!';
...
$_['text_next_choice']         = 'Если у вас есть промо-код на скидку или бонусные баллы, которые вы хотите использовать, выберите соответствующий пункт. <br>Также, можно (приблизительно) узнать стоимость доставки в ваш регион.';
