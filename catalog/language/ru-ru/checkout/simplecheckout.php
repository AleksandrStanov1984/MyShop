...
// Text
$_['text_cart']                      = 'Корзина';
$_['text_title_simplecart']          = 'Ваш заказ';
...
$_['button_update']                  = 'Использовать';
$_['button_continue']                = 'Продолжить покупки';
$_['placeholder_cupon']              = 'Номер промо-кода';
$_['unit_h'] = 'В';
$_['unit_w'] = 'Ш';
$_['unit_l'] = 'Г';
$_['unit'] = 'см';
$_['title_block_checkout'] = 'Оформление заказа';
$_['description_block_checkout'] = 'Для оформления заказа заполните, пожалуйста, все обязательные поля';
?>