	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="footer">
					<p>Generated by <a href="https://thekrotek.com/opencart-extensions/smart-sitemap" title="Smart Sitemap" target="_blank">Smart Sitemap</a> extension from <a href="https://thekrotek.com" title="The Krotek" target="_blank">The Krotek</a>.</p>
				</div>
			</body>
		</html>
	</xsl:template>
