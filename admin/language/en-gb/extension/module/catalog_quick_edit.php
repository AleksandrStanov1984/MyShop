<?php
$_['extension_name']                                = 'Catalog Quick Edit';

// Heading
$_['heading_title']                                 = '<i class="fa fa-list fa-fw ext-icon" style="font-size:14px;color:#F7951D;"></i> <strong>' . $_['extension_name'] . '</strong>';
...
// Menu
$_['menu_catalog_category']                         = 'Categories (CQE)';
$_['menu_catalog_product']                          = 'Products (CQE)';
$_['menu_catalog_filter']                           = 'Filters (CQE)';
$_['menu_catalog_attribute']                        = 'Attributes (CQE)';
$_['menu_catalog_attribute_group']                  = 'Attribute Groups (CQE)';
$_['menu_catalog_option']                           = 'Options (CQE)';
$_['menu_catalog_manufacturer']                     = 'Manufacturers (CQE)';
$_['menu_catalog_download']                         = 'Downloads (CQE)';
$_['menu_catalog_review']                           = 'Reviews (CQE)';
$_['menu_catalog_information']                      = 'Information (CQE)';
