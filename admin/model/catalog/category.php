...
class ModelCatalogCategory extends Model {
	public function addCategory($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "category SET parent_id = '" . (int)$data['parent_id'] . "', `top` = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', `show_whl` = '" . (isset($data['show_whl']) ? (int)$data['show_whl'] : 0) . "', `show_desc` = '" . (isset($data['show_desc']) ? (int)$data['show_desc'] : 0) . "', `column` = '" . (int)$data['column'] . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', date_modified = NOW(), date_added = NOW()");
        ...
        if (isset($data['banner_id'])) {
            $this->db->query("INSERT INTO " . DB_PREFIX . "category_banners SET category_id = '" . (int)$category_id . "', banner_id = '" . (int)$data['banner_id'] . "', width = '" . (int)$data['width'] . "', height = '" . (int)$data['height'] . "', banner_status = '" . $this->db->escape($data['banner_status']) . "'");
        }
	...
	public function editCategory($category_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "category SET parent_id = '" . (int)$data['parent_id'] . "', `top` = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', `show_whl` = '" . (isset($data['show_whl']) ? (int)$data['show_whl'] : 0) . "', `show_desc` = '" . (isset($data['show_desc']) ? (int)$data['show_desc'] : 0) . "', `column` = '" . (int)$data['column'] . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', date_modified = NOW() WHERE category_id = '" . (int)$category_id . "'");
        ...
        $this->db->query("DELETE FROM " . DB_PREFIX . "category_banners WHERE category_id = '" . (int)$category_id . "'");
    ...
    public function getBannerCategory($category_id) {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "category_banners cb WHERE cb.category_id = '" . (int)$category_id . "'");
