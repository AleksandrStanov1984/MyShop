	...
	public function dashboard() {
		...
		$data['token'] = $this->session->data['token'];
          ...
          $data['text_missing'] = $this->language->get('text_missing');
					...
					$data['lost_orders'] = $this->url->link('sale/order', 'token=' . $this->session->data['token'] . '&filter_order_status=0' , 'SSL');

					$total_lost_orders = $this->model_sale_order->getTotalOrders(array('filter_order_status' => '0'));
					
					$data['lost_orders_total'] = ($total_lost_orders > 0) ? $data['lost_orders_total'] = sprintf($this->language->get('text_lost_orders'), $total_lost_orders) : $data['lost_orders_total'] = $this->language->get('text_no_lost_orders');
		...
		//		'status'     => $result['order_status'],
	                        'status'  => $result['order_status'] ? $result['order_status'] : $this->language->get('text_missing'),
