          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($provider['id_provider'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $provider['id_provider']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $provider['id_provider']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $provider['name']; ?></td>
                  <td class="text-right"><?php echo $provider['sort_order']; ?></td>
