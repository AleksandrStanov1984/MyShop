    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
	    ...
	    <label class="col-sm-2 control-label">Куда</label>
            <div class="col-sm-10">
              <input type="text" name="dest" value="<?php echo $dest; ?>" placeholder="" id="input-dest" class="form-control" />
            </div>
	    </div>
        	<div class="form-group">
                <label class="col-sm-2 control-label">Картинка 1</label>
        	...
        	<div class="form-group">
                <label class="col-sm-2 control-label">Картинка 2</label>
