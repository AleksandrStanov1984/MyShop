  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
		<button type="submit" form="form-product" input type="hidden" name="apply" value="1" data-toggle="tooltip" title="<?php echo $button_apply; ?>" class="btn btn-success"><i class="fa fa-check"></i></button>
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li<?php echo $hide_attribute; ?>><a href="#tab-attribute" data-toggle="tab"><?php echo $tab_attribute; ?></a></li>
            <li<?php echo $hide_option; ?>><a href="#tab-option" data-toggle="tab"><?php echo $tab_option; ?></a></li>
            <li<?php echo $hide_recurring; ?>><a href="#tab-recurring" data-toggle="tab"><?php echo $tab_recurring; ?></a></li>
            <li<?php echo $hide_discount; ?>><a href="#tab-discount" data-toggle="tab"><?php echo $tab_discount; ?></a></li>
            <li<?php echo $hide_special; ?>><a href="#tab-special" data-toggle="tab"><?php echo $tab_special; ?></a></li>
            <li<?php echo $hide_images; ?>><a href="#tab-image" data-toggle="tab"><?php echo $tab_image; ?></a></li>
            <li<?php echo $hide_reward; ?>><a href="#tab-reward" data-toggle="tab"><?php echo $tab_reward; ?></a></li>
            <li<?php echo $hide_design; ?>><a href="#tab-design" data-toggle="tab"><?php echo $tab_design; ?></a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              <div class="form-group<?php echo $hide_codes; ?>">
			    <label class="col-sm-2 control-label" for="btn-codes"><?php echo $entry_codes; ?></label>
				<div class="col-sm-10"><a class="btn btn-info btn-block" id="btn-codes"><div class="btn-inline text-left" id="text-codes"><?php echo $text_show; ?></div><div class="btn-inline text-right"><i class="fa fa-chevron-down"></i></div></a></div>
			  </div>
			  <div id="form-group-codes" style="display: none;" class="form-group<?php echo $hide_codes; ?>">
			    <input type="hidden" name="text_hide" value="<?php echo $text_hide; ?>" id="text-hide" />
			    <input type="hidden" name="text_show" value="<?php echo $text_show; ?>" id="text-show" />
                <div class="col-sm-12">
				  <div class="form-group">
			  ...
			  <div class="form-group<?php if ($model_required) { ?> required<?php } ?><?php echo $hide_model; ?>">
              ...
              <div class="form-group<?php echo $hide_price; ?>">
                <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_price; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="price" value="<?php echo $price; ?>" placeholder="<?php echo $entry_price; ?>" id="input-price" class="form-control" />
                </div>
              </div>
              <div class="form-group<?php echo $hide_tax; ?>">
              ...
              <div class="form-group<?php echo $hide_quantity; ?>">
                <label class="col-sm-2 control-label" for="input-quantity"><?php echo $entry_quantity; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="quantity" value="<?php echo $quantity; ?>" placeholder="<?php echo $entry_quantity; ?>" id="input-quantity" class="form-control" />
                </div>
              </div>
              <div class="form-group<?php echo $hide_minimum; ?>">
              ...
              <div class="form-group<?php echo $hide_subtract; ?>">
              ...
              <div class="form-group<?php echo $hide_stock_status; ?>">
              ...
              <div class="form-group<?php echo $hide_shipping; ?>">
			  ...
			  <?php if (!$keyword) { ?>
			  <div class="form-group<?php echo $hide_seo_keyword; ?>">
			  ...
			  <?php } else { ?>
			  <div class="form-group hide<?php echo $hide_seo_keyword; ?>">
			  ...
			  <?php } ?>
              <div class="form-group<?php echo $hide_seo_keyword; ?>" id="seo-url-customs">
              ...
              <div class="form-group<?php echo $hide_date_available; ?>">
              ...
              <div class="form-group<?php echo $hide_dimension; ?>">
              ...
              <div class="form-group<?php echo $hide_length_class; ?>">
              ...
              <div class="form-group<?php echo $hide_weight; ?>">
              ...
              <div class="form-group<?php echo $hide_weight_class; ?>">
              ...
              <div class="form-group<?php echo $hide_status; ?>">
              ...
              <div class="form-group<?php echo $hide_sort_order; ?>">
            ...
            <div class="tab-pane" id="tab-links">
              <div class="form-group<?php echo $hide_manufacturer; ?>">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="product-category" class="well well-sm maxy-scrollbox" style="height: 160px; overflow: auto;">
              ...
              <div class="form-group<?php echo $hide_filter; ?>">
                <label class="col-sm-2 control-label" for="input-filter"><span data-toggle="tooltip" title="<?php echo $help_filter; ?>"><?php echo $entry_filter; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="filter" value="" placeholder="<?php echo $entry_filter; ?>" id="input-filter" class="form-control" />
                  <div id="product-filter" class="well well-sm maxy-scrollbox" style="height: 160px; overflow: auto;">
              ...
              <div class="form-group<?php echo $hide_store; ?>">
              ...
              <div class="form-group<?php echo $hide_download; ?>">
                <label class="col-sm-2 control-label" for="input-download"><span data-toggle="tooltip" title="<?php echo $help_download; ?>"><?php echo $entry_download; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="download" value="" placeholder="<?php echo $entry_download; ?>" id="input-download" class="form-control" />
                  <div id="product-download" class="well well-sm maxy-scrollbox" style="height: 160px; overflow: auto;">
              ...
              <div class="form-group<?php echo $hide_related; ?>">
                <label class="col-sm-2 control-label" for="input-related"><span data-toggle="tooltip" title="<?php echo $help_related; ?>"><?php echo $entry_related; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="related" value="" placeholder="<?php echo $entry_related; ?>" id="input-related" class="form-control" />
                  <div id="product-related" class="well well-sm maxy-scrollbox" style="height: 160px; overflow: auto;">
...
$('input[name=\'manufacturer\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=mass_update/mass_update/autocomplete_manufacturer&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
...
$('input[name=\'related\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=mass_update/mass_update/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
...
//--></script>
  <script type="text/javascript"><!--
$product_name = $('input[name="product_description[<?php echo $config_language_id; ?>][name]"]'); 
$title = $('.product_name');

if ($product_name.val() != '') {
	$title.html(' - ' + $product_name.val()); 
}
