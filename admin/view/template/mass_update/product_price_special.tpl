		...
		success: function(json) {
			...
			if (json['success']) {
				...
				setTimeout(function(){
					...
					$('#product-price<?php echo $product_id; ?>').load('index.php?route=mass_update/product_mass/loadPrice&token=<?php echo $token; ?>&product_id=<?php echo $product_id; ?>');	
					$('#product-price-special<?php echo $product_id; ?>').load('index.php?route=mass_update/product_mass/loadPriceSpecial&token=<?php echo $token; ?>&product_id=<?php echo $product_id; ?>');
				}, 1000)
			}
		}
	});
