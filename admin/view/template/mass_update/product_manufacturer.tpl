	...
	$.ajax({
		...
		success: function(json) {									
			...
			if (json['success']) {
				...
				$('#product-manufacturer<?php echo $product_id; ?>').load('index.php?route=mass_update/product_mass/loadProductManufacturer&token=<?php echo $token; ?>&manufacturer_id=' + manufacturer_id);
