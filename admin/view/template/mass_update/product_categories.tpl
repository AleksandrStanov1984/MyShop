<div class="popover-content" style="height: 192px !important; padding: 0 15px;">
	...
	$.ajax({
		...
		success: function(json) {									
			...
			if (json['success']) {
				...
				$('#product-categories-<?php echo $product_id; ?>').load('index.php?route=mass_update/product_mass/loadCategory&token=<?php echo $token; ?>&product_id=<?php echo $product_id; ?>');
