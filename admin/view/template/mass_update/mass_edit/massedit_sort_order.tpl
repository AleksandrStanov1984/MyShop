...
<div class="modal-body" id="body-mass-product-sort">
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-mass-product-sort" class="form-horizontal">	
	...
	<div class="form-group">	
	  <label class="col-sm-2 control-label" for="input-sort-order-method"><?php echo $entry_method_edit; ?></label>
	  <div class="col-sm-10">
		<select name="sort_order_method" id="input-sort-order-method" class="form-control">
          <option value="start"><?php echo $text_start; ?></option>
		  <option value="equality"><?php echo $text_equality; ?></option>
        </select>
	  </div>
	</div>
	<div class="form-group">
      <label class="col-sm-2 control-label" for="input-sort-order"><?php echo $entry_value_edit; ?></label>
      <div class="col-sm-10">
        <input type="text" name="sort_order" value="" placeholder="<?php echo $entry_value_edit; ?>" id="input-sort-order" class="form-control" />
      </div>
    </div>
  </form>
</div>
