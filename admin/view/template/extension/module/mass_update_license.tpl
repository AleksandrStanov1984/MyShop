        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-license" class="form-horizontal">
		  ...
		  <div class="tab-content">
			<div class="tab-pane active" id="tab-license">
			  <input type="hidden" name="mass_update_license_secret_key" value="<?php echo $secret_key; ?>" />
			  <div class="form-group">
		        <div class="col-sm-12">
		          <div class="input-group"><span class="input-group-addon"><i class="fa fa-shopping-cart"></i></span><input type="text" name="mass_update_license_order_id" value="<?php echo $mass_update_license_order_id; ?>" placeholder="<?php echo $entry_order_id; ?>" class="form-control" /></div>
                </div>
		      </div>
		      <div class="form-group">
		        <div class="col-sm-12">
		          <div class="input-group"><span class="input-group-addon"><i class="fa fa-superscript"></i></span><input type="text" name="mass_update_license_product_code" value="<?php echo $mass_update_license_product_code; ?>" placeholder="<?php echo $entry_product_license_code; ?>" class="form-control" /></div>
                </div>
		      </div>
		      <div class="form-group">
		        <div class="col-sm-12">
		          <div class="input-group"><span class="input-group-addon"><i class="fa fa-key"></i></span><input type="text" name="mass_update_license_key" value="<?php echo $mass_update_license_key; ?>" placeholder="<?php echo $entry_license_key; ?>" class="form-control" /></div>
                </div>
		      </div>
			</div>
