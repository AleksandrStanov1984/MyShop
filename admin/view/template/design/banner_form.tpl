                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    <td class="text-center">
                      <?php if ($banner_image['hide'] == 1) { ?>
                      <input type="checkbox" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][hide]" value="1" checked="checked" id="input-hide" />
                      <?php } else { ?>
                      <input type="checkbox" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][hide]" value="1" id="input-hide" />
                      <?php } ?></td>
...
function addImage(language_id) {
    ...
    html += '  <td class="text-center"><input type="checkbox" name="banner_image[' + language_id + '][' + image_row + '][hide]" value="1" /></td>';
