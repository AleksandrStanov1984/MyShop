...
<div id="content">
				...
				<div class="tab-content">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="alert alert-info">
										<small><?php echo $text_default_product_setting; ?></small>
									</div>
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_setting[tax_class_id]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_setting[subtract]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_setting[stock_status_id]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_setting[shipping]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_setting[length_class_id]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_setting[weight_class_id]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											...
											<select name="csv_setting[layout][<?php echo $store['store_id']; ?>]" class="form-control input-sm">
												<option value="">&nbsp;</option>
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_setting[status]" class="form-control input-sm">
								...
								<div class="col-sm-6">
									<div class="alert alert-info">
										<small><?php echo $text_default_options_setting; ?></small>
									</div>
									<div class="form-group form-group-sm">
										<label class="col-sm-5 control-label"><?php echo $entry_option_type; ?></label>
										<div class="col-sm-7">
											<select name="csv_setting[option_type]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_setting[option_required]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_setting[option_subtract_stock]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_setting[option_price_prefix]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_setting[option_points_prefix]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										<label class="col-sm-5 control-label"><?php echo $entry_option_price_prefix; ?></label>
										<div class="col-sm-7">
											<select name="csv_setting[option_weight_prefix]" class="form-control input-sm">
									...
									<div class="alert alert-info" style="margin-top: 10px;margin-bottom: 10px">
										<small><?php echo $text_exclude_filter_field; ?></small>
									</div>
									<div class="form-inline" id="exclude_field_list">
										<?php $product_exclude_field_row = 0; ?>
										<?php if (isset($csv_setting['exclude_field']) && !empty($csv_setting['exclude_field'])) { ?>
										<?php foreach ($csv_setting['exclude_field'] as $exclude_filed) {?>
										<div id="product-exclude-field-row<?php echo $product_exclude_field_row; ?>" class="input-group input-group-sm csvprice_pro-exclude-item">
											<input style="width:auto" type="text" name="csv_setting[exclude_field][]" readonly class="form-control input-sm" value="<?php echo $exclude_filed; ?>">
											<div class="input-group-btn"><a onclick="$('#product-exclude-field-row<?php echo $product_exclude_field_row; ?>').remove();" data-toggle="tooltip" title="" class="btn btn-danger btn-sm" data-original-title="<?php echo $button_remove; ?>"><i class="fa fa-minus-circle"></i></a></div>
										</div>
										<?php $product_exclude_field_row++; ?>
										<?php } ?>
										<?php } ?>
									</div>
									<div class="input-group">
										<select id="product_exclude_field_select" class="form-control input-sm">
										...
										<div class="input-group-btn">
											<!-- Buttons -->
											<a onclick="addProductExcludeFieldRow();" data-toggle="tooltip" title="" class="btn btn-success btn-sm" data-original-title="<?php echo $button_insert; ?>"><i class="fa fa-plus-circle"></i></a>
										</div>
									</div>
								</div>
							</div>
					...
					<div id="tab_fields" class="tab-pane fade">
						...
						<form action="<?php echo $action; ?>" method="post" id="form_product_fields" enctype="multipart/form-data" class="form-horizontal">
							...
							<table id="table-product-field" class="table table-hover table-striped table-macros-field">
								<thead>
									<tr>
								...
								<tbody id="tbody_data">
									...
									<tr id="product-field-row<?php echo $product_field_row; ?>">
										<td class="text-left" width="46%"><input type="hidden" name="csv_product_field[<?php echo $field_key; ?>]" value="<?php echo $filed_name; ?>" /><?php echo $field_key; ?></td>
								...
								<tbody id="tbody_form" class="csvpricepro_tbody-form">
									<tr>
										<td>
											<select id="product_field_select" class="form-control input-sm">
												<?php foreach ($product_field as $field_caption) { ?>
												<option value="<?php echo $field_caption; ?>"><?php echo $field_caption; ?></option>
												<?php } ?>
											</select>
										...
										<td>
											<input type="text" id="product_field_input" value="" class="form-control input-sm" />
										</td>
							...
							<table id="table-product-attribute-field" class="table table-hover table-striped">
								<thead>
									<tr>
										<th><?php echo $entry_attribute_name; ?></th>
										<th><?php echo $entry_csv_name; ?></th>
										<th>&nbsp;</th>
									</tr>
								</thead>
								<?php $product_attribute_field_row = 0; ?>
								<?php if (!empty($csv_product_attribute_field)) { ?>
								<tbody id="tbody_data-attribute_field">
									<?php foreach ($csv_product_attribute_field as $attribute) { ?>
									<tr id="product-attribute-field-row<?php echo $product_attribute_field_row ; ?>">
										<td class="text-left" width="46%"><input type="hidden" name="csv_product_attribute_field[<?php echo $attribute['id']; ?>][id]" value="<?php echo $attribute['id']; ?>"><?php echo $attribute['name']; ?></td>
										<td class="text-left"><input type="hidden" name="csv_product_attribute_field[<?php echo $attribute['id']; ?>][csv_name]" value="<?php echo $attribute['csv_name']; ?>"><?php echo $attribute['csv_name']; ?></td>
										<td class="text-center"><a onclick="$('#product-attribute-field-row<?php echo $product_attribute_field_row; ?>').remove();" data-toggle="tooltip" title="" class="btn btn-danger btn-sm" data-original-title="<?php echo $button_remove; ?>"><i class="fa fa-minus-circle"></i></a></td>
									</tr>
									<?php $product_attribute_field_row++; ?>
									<?php } ?>
								</tbody>
								<tbody id="tbody_foot-attribute_field"></tbody>
								<?php } else { ?>
								<tbody id="tbody_foot-attribute_field">
									<tr>
										<td colspan="3">
											<?php echo $text_no_results; ?>
										</td>
								...
								<?php } ?>
								<tbody id="tbody_form-attribute_field" class="csvpricepro_tbody-form">
									<tr>
										<td>
											<input type="text" name="product_attribute_select" value="" placeholder="autocomplete" id="input-product-attribute-select" class="form-control input-sm" autocomplete="off">
											<input type="hidden" name="product_attribute_value" value="" id="input-product-attribute-value">
										</td>
										<td><input type="text" name="product_attribute_csv_name" id="input-product-attribute-csv-name" value="" class="form-control input-sm"></td>
										<td width="50" class="text-center"><a onclick="addProductAttributeFieldRow();" data-toggle="tooltip" title="" class="btn btn-success btn-sm" data-original-title="<?php echo $button_insert; ?>"><i class="fa fa-plus-circle"></i></a></td>
									</tr>
								</tbody>
							</table>
						</form>
							...
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_export[category_parent]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_export[export_related]" class="form-control input-sm">
												<option value="0"<?php if (!isset($csv_export['export_related']) || $csv_export['export_related'] == 0 ) { echo ' selected="selected"';} ?>><?php echo $text_disabled; $csv_export['export_related'] = '' ?></option>
												<?php foreach($csv_export_key_related as $key => $name) { ?>
												<?php if ($csv_export['export_related'] == $key) { ?>
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_export[product_filter]" id="w_product_filter" onchange="showProductFilter();" class="form-control input-sm">
									...
									<div id="wrap_product_filter" class="well well-sm">
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-7">
												<input type="text" name="csv_export[filter_name]" class="form-control input-sm" value="<?php if (isset($csv_export['filter_name'])) { ?><?php echo $csv_export['filter_name']; ?><?php } ?>" />
											</div>
										</div>
										<div class="form-group form-group-sm">
											<label class="col-sm-5 control-label"><?php echo $entry_filter_sku; ?></label>
											<div class="col-sm-7">
												<input type="text" name="csv_export[filter_sku]" class="form-control input-sm" value="<?php if (isset($csv_export['filter_sku'])) { ?><?php echo $csv_export['filter_sku']; ?><?php } ?>" />
											</div>
										</div>
										<div class="form-group form-group-sm">
											<label class="col-sm-5 control-label"><?php echo $entry_filter_location; ?></label>
											<div class="col-sm-7">
												<input type="text" name="csv_export[filter_location]" class="form-control input-sm" value="<?php if (isset($csv_export['filter_location'])) { ?><?php echo $csv_export['filter_location']; ?><?php } ?>" />
											</div>
										</div>
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-7">
												<div class="row">
													<div class="col-sm-6">
														<select name="csv_export[filter_price_prefix]" class="form-control input-sm">
										...
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-7">
												<div class="row">
													<div class="col-sm-6">
														<select name="csv_export[filter_quantity_prefix]" class="form-control input-sm">
										...
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-7">
												<select name="csv_export[filter_stock_status]" class="form-control input-sm">
										...
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-7">
												<select name="csv_export[filter_status]" class="form-control input-sm">
							...
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<input type="text" name="key_field_manufacturer_input" placeholder="<?php echo $entry_import_manufacturer; ?>" value="<?php if(isset($csv_import['key_field_manufacturer_name'])) echo $csv_import['key_field_manufacturer_name']; ?>" id="key_field_manufacturer_input" class="form-control input-sm" />
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_import[delimiter_category]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_import[fill_category]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_import[top]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_import[calc_mode]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_import[empty_field]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_import[product_disable]" class="form-control input-sm">
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<select name="csv_import[quantity_reset]" class="form-control input-sm">
								...
								<div class="col-sm-6">
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											...
											<input type="text" name="to_manufacturer" value="<?php if(isset($csv_import['to_manufacturer_name'])) echo $csv_import['to_manufacturer_name']; ?>" placeholder="" id="to_manufacturer" class="form-control input-sm" />
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											...
											<input type="text" name="import_main_category" value="<?php if (isset($csv_import['main_category']))echo $csv_import['main_category']; ?>" placeholder="" id="import_main_category" class="form-control input-sm" />
									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-7">
											<input type="text" name="csv_import[img_path]" class="form-control input-sm" value="<?php if(isset($csv_import['img_path'])) echo $csv_import['img_path']; ?>" />
										</div>
									</div>
									<div class="form-group form-group-sm">
									...
									<div class="well well-sm">
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-7">
												<input type="text" name="csv_import[exclude_filter_name]" class="form-control input-sm" value="<?php if (isset($csv_import['exclude_filter_name'])) echo $csv_import['exclude_filter_name']; ?>" />
											</div>
										</div>
										<div class="form-group form-group-sm">
											<label class="col-sm-5 control-label"><?php echo $entry_import_exclude_filter_desc; ?></label>
											<div class="col-sm-7">
												<input type="text" name="csv_import[exclude_filter_desc]" class="form-control input-sm" value="<?php if (isset($csv_import['exclude_filter_desc'])) echo $csv_import['exclude_filter_desc']; ?>" />
											</div>
										</div>
										<div class="form-group form-group-sm">
											<label class="col-sm-5 control-label"><?php echo $entry_import_exclude_filter_attr; ?></label>
											<div class="col-sm-7">
												<input type="text" name="csv_import[exclude_filter_attr]" class="form-control input-sm" value="<?php if (isset($csv_import['exclude_filter_attr'])) echo $csv_import['exclude_filter_attr']; ?>" />
											</div>
										</div>
									</div>
								</div>
					...
					<div id="tab_macros" class="tab-pane fade">
						<form action="<?php echo $action; ?>" method="post" id="form_macros" enctype="multipart/form-data" class="form-horizontal">
							...
							<table id="table_macros_field" class="table table-hover table-striped table-macros-field">
								<thead>
									<tr>
								...
								<tbody id="tbody_data">
									...
									<tr id="macros-field-row<?php echo $field_row; ?>">
										...
										<td class="text-left"><input type="hidden" name="product_macros[<?php echo $field_row; ?>][field_type]" value="<?php echo isset($fields['field_type']) ? $fields['field_type']: 'HTML'; ?>"/><?php echo isset($fields['field_type']) ? $fields['field_type']: 'HTML'; ?></td>
								...
								<tbody id="tbody_form" class="csvpricepro_tbody-form">
									<tr>
										...
										<td>
											<select id="field_type" class="form-control input-sm">
							...
							<?php if(isset($help_macro_field_type)) { ?>
							<p class="help-block"><?php echo $help_macro_field_type; ?></p>
							<?php } ?>
						</form>
						<div class="row">
							<div class="col-sm-12">
	...
	<script><!--
		...
		function addMacrosRow() {
				var tbl_name = $('#table_macros_field #tbl_name option:selected').val(),
					field_name = $('#table_macros_field #tbl_field_name option:selected').val(),
					csv_name = $('#table_macros_field #csv_name').val(),
					csv_caption = $('#table_macros_field #csv_caption').val(),
					field_type = $('#table_macros_field #field_type').val();
				...
				html += '    <td class="text-left"><input type="hidden" name="product_macros[' + field_row + '][field_type]" value="' + field_type + '" size="1" />' + field_type + '</td>';
				...
				html += '  </tr>';
				if (field_row < 1) {
					$('#table_macros_field #tbody_foot').html('');
				}
				$('#table_macros_field #tbody_foot').append(html);
				resetFormMacros();
				$('#table_macros_field #tbl_name option').change();
				field_row++;
			}
		...
		function createProfile(key) {
			...
			$.ajax({
				...
				success: function(json){
					...
					var l = '<?php echo $action; ?>&profile_type=' + key +'&profile_id=' + obj.id;
		...
		jQuery(document).ready(function ($) {
			...
			if(s) {
				...
				$('#progress-import').parent().after('<div class="alert alert-info" style="color: #333"><i class="fa fa-check-circle"></i> <?php echo $text_begin_auto_import; ?> </div>');
		...
		$.ajax({
			...
			success: function(json) {
				if(json.processed == 0 ) {
					$('.alert').remove();
					$('#progress-import').parent().hide();
					$('#progress-import').parent().after('<div class="alert alert-danger" style="color: #333"><i class="fa fa-exclamation-circle"></i> ' + json.message + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
					return false;
				}
				if(json.status == 100) {
					$('.alert').remove();
					$('#progress-import .progress-bar').css('width', '100%').attr('aria-valuenow', 100);
					$('#progress-import').parent().after('<div class="alert alert-success" style="color: #333"><i class="fa fa-check-circle"></i> ' + json.message + '</div>');
					...
					$('#progress-import').parent().after('<div class="alert alert-info" style="color: #333"><i class="fa fa-check-circle"></i> ' + json.message + '</div>');
		...
		var product_exclude_field_row = <?php echo $product_exclude_field_row; ?>;
		
		function addProductExcludeFieldRow() {
		var field = $('#product_exclude_field_select option:selected').val();
		
		var html  = '<div id="product-exclude-field-row' + product_exclude_field_row + '" class="input-group input-group-sm csvprice_pro-exclude-item">';
		html += '<input style="width:auto" type="text" name="csv_setting[exclude_field][]" readonly class="form-control input-sm" value="' + field + '">';									
		html += '<div class="input-group-btn"><a onclick="$(\'#product-exclude-field-row' + product_exclude_field_row + '\').remove();" data-toggle="tooltip" title="" class="btn btn-danger btn-sm" data-original-title="<?php echo $button_remove; ?>"><i class="fa fa-minus-circle"></i></a></div>';
		html += '</div>';
		
		if (product_exclude_field_row < 1) {
			$('#exclude_field_list').html('');
		}
		$('#exclude_field_list').append(html);
		product_exclude_field_row++;
		}
		// CSV Attribute Custom Field
		var product_attribute_field_row = <?php echo $product_attribute_field_row ? $product_attribute_field_row : 0 ; ?>;
		$('#input-product-attribute-select').autocomplete({
		'source': function(request, response) {
			$.ajax({
		...
		'select': function(item) {
			$('#input-product-attribute-select').val(item['category'] +': ' + item['label']);
			$('#input-product-attribute-value').val(item['value']);
		}
		 });
		function addProductAttributeFieldRow() {
			var attribute_name = $('#input-product-attribute-select').val(), attribute_id = $('#input-product-attribute-value').val(), csv_name = $('#input-product-attribute-csv-name').val();
			if( csv_name == '' || attribute_id <= 0) return;
			var html  = '<tr id="product-attribute-field-row' + product_attribute_field_row + '">';
			html += '<td class="text-left" width="46%"><input type="hidden" name="csv_product_attribute_field[' +attribute_id + '][id]" value="' + attribute_id + '">' +  attribute_name + '</td>';
			html += '<td class="text-left"><input type="hidden" name="csv_product_attribute_field[' +attribute_id + '][csv_name]" value="' + csv_name + '">' +csv_name + '</td>';
			html += '<td class="text-center"><a onclick="$(\'#product-attribute-field-row' + product_attribute_field_row + '\').remove();" data-toggle="tooltip" title="" class="btn btn-danger btn-sm" data-original-title="<?php echo $button_remove; ?>"><i class="fa fa-minus-circle"></i></a>';
			html += '</tr>';
			if (product_attribute_field_row < 1) $('#table-product-attribute-field #tbody_foot-attribute_field').html('');
			$('#table-product-attribute-field #tbody_foot-attribute_field').append(html);
			$('#input-product-attribute-select').val('');
			$('#input-product-attribute-value').val(0);
			$('#input-product-attribute-csv-name').val('');
			product_attribute_field_row++;
		}
	//--></script>
	<?php echo $app_footer; ?>
</div>
